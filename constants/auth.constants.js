...
export const NEW_PASSWORD_MIN_LENGTH =
	'New password must be at least 6 characters.';
export const PASSWORD_NOT_MATCHED = 'Password not matched';
export const GET_ROLES_SUCCESS = 'Roles fetched successfully';
export const SECURITY_LOGS_FETCHED_SUCCESS =
	'Security logs fetched successfully';
export const OLD_PASSWORD_NOT_MATCHED = 'Old password not matched';
